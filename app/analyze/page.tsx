...
import { Upload, FileText, Users, MessageCircle, Trophy, Medal, Award, Calendar, RotateCcw } from "lucide-react"
            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                            ...
                            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-gray-800">{analysisResult.totalMessages.toLocaleString()}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-gray-800">{analysisResult.userMessages.length}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="divide-y divide-gray-100">
                                {analysisResult.userMessages
                                    ...
                                    .map((user, index) => (
                                        <div
                                            key={user.user}
                                            className={`px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors ${index < 3 ? "bg-yellow-50" : ""
                                                }`}
                                        >
                                            <div className="flex items-center space-x-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-500">
                                                        전체의 {((user.count / analysisResult.totalMessages) * 100).toFixed(1)}%
                                                    </p>
                                                </div>
                                            </div>

                                            <div className="text-right">
                                                <p className="text-lg font-bold text-gray-800">{user.count.toLocaleString()}</p>
                ...
                {!analysisResult && !isUploading && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">파일을 업로드하면 분석 결과가 여기에 표시됩니다</p>
                    </div>
                )}
            </div>
        </div>
